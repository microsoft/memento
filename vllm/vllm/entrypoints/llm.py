...
class LLM:
    ...
    def __init__(
        ...
        *,
        ...
        block_masking_config: dict[str, Any] | BlockMaskingConfig | None = None,
        **kwargs: Any,
    ) -> None:
        """LLM constructor."""
        ...
        if profiler_config is not None:
            ...
            profiler_config_instance = ProfilerConfig()
        if block_masking_config is not None:
            if isinstance(block_masking_config, dict):
                block_masking_config_instance = BlockMaskingConfig(
                    **{
                        k: v
                        for k, v in block_masking_config.items()
                        if is_init_field(BlockMaskingConfig, k)
                    }
                )
            else:
                block_masking_config_instance = block_masking_config
        else:
            block_masking_config_instance = None
        ...
        engine_args = EngineArgs(
            ...
            block_masking_config=block_masking_config_instance,

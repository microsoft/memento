...
class EngineArgs:
    ...
    block_masking_config: BlockMaskingConfig | None = None
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        vllm_group.add_argument(
            "--block-masking-config", "-bmc", **vllm_kwargs["block_masking_config"]
        )
        vllm_group.add_argument(
    ...
    def create_engine_config(
        ...
        config = VllmConfig(
            ...
            block_masking_config=self.block_masking_config,

...
class CachedRequestData:
    ...
    # Number of tokens that have been removed via KV cache compaction.
    # Used to compute physical seq_lens = num_computed_tokens - compacted_token_counts.
    # For non-compacted requests, this is 0.
...
class SchedulerOutput:
    ...
    # for KV cache compaction. The worker executes these copy operations

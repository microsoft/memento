...
class InputBatch:
    def __init__(
        ...
        # Number of tokens that have been compacted (physically removed) per request.
        # Used to compute physical seq_lens = num_computed_tokens - compacted_tokens.
        self.compacted_tokens_cpu = np.zeros(max_num_reqs, dtype=np.int32)
    ...
    def add_request(
        ...
        # New requests start with 0 compacted tokens
    ...
    def condense(self) -> None:
        ...
        while empty_req_indices:
            ...
            self.compacted_tokens_cpu[empty_index] = self.compacted_tokens_cpu[
                last_req_index
            ]
